...
static const Rule rules[] = {
	...
	{ "firefox",  NULL,     NULL,                       0,    	  0,          0,            0,        	1.0, 1.0,			-1 },
	{ "QtCreator",NULL,     NULL,          	            0,    	  0,          0,            0,        	1.0, 0.9,			-1 },
	{ "Alacritty",NULL,     NULL,                       0,        	  0,          1,            1,        	1.0, 0.85,			-1 },
	{ "code-oss", NULL,	NULL,                       0,	      	  0,	      0,	    0,		1.0, 0.95,			-1},
	{ "VSCodium",NULL,     NULL,                0,        	  0,          0,            0,        	1.0, 0.95,			-1 },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-c", "-l", dmenu_lines, "-m", dmenumon, "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbordercolor, "-sf", selfgcolor, NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,         	XK_Return, spawn_ssh_aware,{.v = termcmd } },
